...
import com.bellar.util.PureNetUtil;
...
public class Dome1 {
	 ...
	 */
	    ...
	    public static String excute(){
	        String url="http://v.juhe.cn/weather/citys?key=686a55b1ea32c28c190ba6df1a54f1a1";//接口URL
	    ...
	    public static void main(String[] args) {
	        System.out.println(getIDBycityName("郑州"));
	    }
